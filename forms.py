...
from wtforms.fields import StringField, TextField, SubmitField, TextAreaField, PasswordField
from wtforms.validators import DataRequired, ValidationError, Email


class ContactForm(FlaskForm):
    name = TextField('Nombre', validators=[DataRequired(message= "Please enter your name")])
